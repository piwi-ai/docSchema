...
export const certificatoMorte: DocumentTypeDef = {
    ...
    description:
        'Certificato/Estratto che attesta il decesso, richiesto quando il venditore/acquirente è vedovo/a',
    references: [
        ref(
    ...
    jsonSchema: objectSchema(
        {
            ...
            codiceFiscaleDefunto: codiceFiscale(
                'Codice Fiscale del defunto — fondamentale per cross-reference con successione (extract without spaces)',
            ),
            ...
            statoCivile: enumField(
                'Stato civile del defunto al momento del decesso',
                STATO_CIVILE_VALUES,
            ),
