...
export const procura: DocumentTypeDef = {
    ...
    name: 'Procura',
    description:
        "Atto notarile che conferisce il potere di rappresentanza per compiere atti per conto di un'altra persona",
    references: [
        ref(
            'Art. 1392 Codice Civile — Forma della procura',
            'https://www.normattiva.it/uri-res/N2Ls?urn:nir:stato:codice.civile:1942-03-16;262~art1392',
    ...
    jsonSchema: objectSchema(
        {
            ...
            codiceFiscaleMandante: codiceFiscale(
                'Codice Fiscale del mandante (extract without spaces)',
            ),
            nomeMandatario: nome(),
            cognomeMandatario: cognome(),
            codiceFiscaleMandatario: codiceFiscale(
                'Codice Fiscale del mandatario (extract without spaces)',
            ),
