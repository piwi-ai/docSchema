...
export const contrattoPrelim: DocumentTypeDef = {
    ...
    references: [
        ref(
            ...
            'https://www.normattiva.it/uri-res/N2Ls?urn:nir:stato:codice.civile:1942-03-16;262~art1351',
            ReferenceType.REGULATION,
        ),
        ref(
            'Agenzia delle Entrate — Registrazione preliminare',
            'https://www.agenziaentrate.gov.it/portale/web/guest/schede/registrazione/registrazione-preliminare',
    ...
    jsonSchema: objectSchema(
        {
            acquirenti: {
                ...
                items: {
                    type: 'object',
                    properties: semplicePersonaProps,
                    required: semplicePersonaReq,
                },
            },
            venditori: {
                type: 'array',
            ...
            dataRogito: datePattern(
                'Data prevista per il rogito definitivo in formato europeo DD/MM/YYYY',
            ),
            mediatore: text(
                "Nome dell'agenzia immobiliare o del mediatore (Art. 35 D.Lgs. 223/2006)",
            ),
