...
export const f24: DocumentTypeDef = {
    ...
    references: [
        ref(
            ...
            'https://www.agenziaentrate.gov.it/portale/web/guest/schede/pagamenti/f24',
            ReferenceType.DOCUMENTATION,
        ),
        ref(
            'Tabella codici tributo',
            'https://www.agenziaentrate.gov.it/portale/web/guest/codici-tributo',
    ...
    jsonSchema: objectSchema(
        {
            ...
            tributi: arrayOfObjects(
                ...
                ['codiceTributo', 'importoDebito'],
                'Elenco tributi/contributi versati',
            ),
