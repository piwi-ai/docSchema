...
export const conformitaImpianti: DocumentTypeDef = {
    ...
    description:
        'Dichiarazioni di conformità degli impianti (elettrico, idraulico, gas, riscaldamento) ai sensi del DM 37/2008',
    references: [
        ref(
            'DM 37/2008 — Sicurezza impianti',
            'https://www.normattiva.it/uri-res/N2Ls?urn:nir:stato:decreto.ministeriale:2008-01-22;37',
    ...
    jsonSchema: objectSchema(
        {
            tipoImpianto: text(
                'Tipo di impianto certificato (es. elettrico, idraulico, gas, riscaldamento, climatizzazione, ascensore, elettrico e termoidraulico)',
            ),
