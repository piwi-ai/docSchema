/**
 * Standard Italian document processing workflows.
 *
 * These workflows are shared across all Italian verticals because
...
/** Standard Italian extraction + identification workflows, used by all IT verticals. */
export const italianWorkflows: WorkflowDef[] = [extractionWorkflow, identificationWorkflow];
