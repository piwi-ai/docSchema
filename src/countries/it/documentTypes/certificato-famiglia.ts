...
const RELAZIONE_FAMILIARE_DESC =
    'Relazione familiare (es. intestatario, coniuge, convivente, figlio/a, padre, madre, fratello/sorella, nipote)';

export const certificatoFamiglia: DocumentTypeDef = {
    id: 'doc-famiglia',
    name: 'Certificato di Stato di Famiglia',
    description:
        'Certificato anagrafico che attesta la composizione del nucleo familiare, utile per verifiche sul regime patrimoniale',
    references: [
        ref(
    ...
    jsonSchema: objectSchema(
        {
            ...
            codiceFiscaleIntestatario: codiceFiscale(
                "Codice Fiscale dell'intestatario (extract without spaces)",
            ),
