...
import { text, dateUS, objectSchema, ref, address, parcelNumber } from '../helpers.js';
...
export const titleReport: DocumentTypeDef = {
    ...
    description:
        'Preliminary title report or title abstract showing ownership history and encumbrances',
    references: [
        ref(
