/**
 * Austria specific field helpers.
 */
...
/** Sozialversicherungsnummer (National ID) */
export const personalId = (desc = 'Sozialversicherungsnummer') =>
    ({ type: 'string' as const, description: desc });

/** UID-Nummer (VAT Number) */
export const vat = (desc = 'UID-Nummer') =>
    ({ type: 'string' as const, description: desc });
