...
export const estrattoMatrimonio: DocumentTypeDef = {
    ...
    references: [
        ...
        ref('Art. 159 Codice Civile — Regime patrimoniale', 'https://www.normattiva.it/uri-res/N2Ls?urn:nir:stato:codice.civile:1942-03-16;262~art159', ReferenceType.REGULATION),
    ],
