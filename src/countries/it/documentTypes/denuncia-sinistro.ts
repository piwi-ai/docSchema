...
import { text, date, enumField, objectSchema, ref, codiceFiscale, targa } from '../helpers.js';
...
export const denunciaSinistro: DocumentTypeDef = {
    ...
    description:
        'Constatazione amichevole (CAI/CID) o denuncia sinistro — dinamica, danni, veicoli',
    references: [
        ref(
            'ANIA — Modulo CAI/CID',
            'https://www.ania.it/it/sala-stampa/focus-on/focus-on-constatazione-amichevole-incidente',
            ReferenceType.DOCUMENTATION,
        ),
        ref(
            'Art. 143 Codice delle Assicurazioni — Denuncia sinistro',
    ...
    jsonSchema: objectSchema(
        {
            ...
            autoritaIntervenuta: enumField('Autorità intervenuta', [
                'Polizia Stradale',
                'Carabinieri',
                'Polizia Municipale',
                'nessuna',
