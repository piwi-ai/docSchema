...
export const sentenzaSeparazione: DocumentTypeDef = {
    ...
    description:
        "Provvedimento giudiziario di separazione legale o divorzio, rilevante per la determinazione dei diritti patrimoniali sull'immobile",
    references: [
        ref(
            'Art. 150–158 Codice Civile — Separazione',
            'https://www.normattiva.it/uri-res/N2Ls?urn:nir:stato:codice.civile:1942-03-16;262~art150',
    ...
    jsonSchema: objectSchema(
        {
            ...
            tipoProvvedimento: enumField('Tipo di provvedimento', [
                'separazione consensuale',
                'separazione giudiziale',
                'divorzio',
            ]),
            disposizioniPatrimoniali: text(
                'Disposizioni relative ai beni immobili — copiare TESTUALMENTE dal documento, senza riformulare o riassumere (es. assegnazione casa coniugale)',
            ),
            passaggioInGiudicato: date(
                'Data di passaggio in giudicato in formato europeo DD.MM.YYYY',
            ),
        },
