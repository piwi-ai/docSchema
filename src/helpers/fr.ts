...
/** Numéro de sécurité sociale (NIR) (National ID) */
export const personalId = (desc = 'Numéro de sécurité sociale (NIR)') =>
    ({ type: 'string' as const, description: desc });

/** TVA (VAT Number) */
export const vat = (desc = 'TVA') =>
    ({ type: 'string' as const, description: desc });
