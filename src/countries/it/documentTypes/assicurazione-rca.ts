...
export const assicurazioneRca: DocumentTypeDef = {
    ...
    references: [
        ref('IVASS — Codice delle Assicurazioni', 'https://www.ivass.it/normativa/nazionale/primaria/index.html', 'regulation'),
        ref('ANIA — Attestato di Rischio', 'https://www.ania.it/', 'documentation'),
    ],
