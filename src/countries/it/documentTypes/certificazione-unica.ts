...
export const certificazioneUnica: DocumentTypeDef = {
    ...
    references: [
        ref(
            'Agenzia delle Entrate — Certificazione Unica',
            'https://www.agenziaentrate.gov.it/portale/web/guest/cu-certificazione-unica',
            ReferenceType.DOCUMENTATION,
        ),
        ref(
            'Specifiche tecniche CU (tracciato record)',
            'https://www.agenziaentrate.gov.it/portale/web/guest/cu-certificazione-unica/specifiche-tecniche-cu',
