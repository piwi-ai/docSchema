...
import { num, date, objectSchema, ref, nome, cognome, codiceFiscale } from '../helpers.js';
...
export const isee: DocumentTypeDef = {
    ...
    references: [
        ref(
            'INPS — ISEE',
            'https://www.inps.it/it/it/dettaglio-scheda.schede-servizio-strumento.schede-servizi.isee-indicatore-della-situazione-economica-equivalente-50498.isee-indicatore-della-situazione-economica-equivalente.html',
            ReferenceType.DOCUMENTATION,
        ),
        ref(
            'DSU — Modulo e istruzioni',
            'https://servizi2.inps.it/servizi/CircMessStworker/VisualizzaDoc.aspx?inpsdoc=Circolare%20numero%20137%20del%2007-10-2016.htm',
