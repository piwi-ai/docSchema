...
export const entityTypes: EntityTypeDef[] = [
    {
        ...
        dataSources: [
            {
                docTypeId: DOC_IDS.DRIVERS_LICENSE,
                enabled: true,
                isRequired: true,
                canCreateEntity: true,
                fieldMappings: [
                    fm(F.FIRST_NAME, F.FIRST_NAME, nameMatch()),
                    fm(F.LAST_NAME, F.LAST_NAME, nameMatch()),
                    fm(F.DATE_OF_BIRTH, F.DATE_OF_BIRTH, nameMatch()),
                    fm(F.ADDRESS, F.ADDRESS, nameMatch()),
                    fm(F.ID_TYPE, F.ID_TYPE, nameMatch()),
                    fm(F.ID_NUMBER, F.ID_NUMBER, nameMatch()),
                    fm('expirationDate', F.ID_EXPIRATION_DATE, nameMatch()),
                ],
            },
            {
                docTypeId: DOC_IDS.PURCHASE_AGREEMENT,
                enabled: true,
                canCreateEntity: true,
                fieldMappings: [
                    fm('seller.firstName', F.FIRST_NAME, nameMatch()),
                    fm('seller.lastName', F.LAST_NAME, nameMatch()),
                    fm('seller.address', F.ADDRESS, nameMatch()),
                ],
            },
            {
                docTypeId: DOC_IDS.DEED,
                enabled: true,
                fieldMappings: [
            ...
            {
                docTypeId: DOC_IDS.CLOSING_DISCLOSURE,
                enabled: true,
                fieldMappings: [
            ...
            {
                docTypeId: DOC_IDS.CONTACT,
                enabled: true,
                fieldMappings: [
                    fm(F.FIRST_NAME, F.FIRST_NAME, nameMatch()),
                    fm(F.LAST_NAME, F.LAST_NAME, nameMatch()),
                    fm(F.PHONE, F.PHONE, nameMatch()),
                    fm(F.EMAIL, F.EMAIL, nameMatch()),
                ],
            },
        ],
    ...
    },
    {
        ...
        dataSources: [
            ...
            },
            {
                ...
                canCreateEntity: true,
                fieldMappings: [
                    fm('buyer.firstName', F.FIRST_NAME, nameMatch()),
                    fm('buyer.lastName', F.LAST_NAME, nameMatch()),
            ...
            {
                docTypeId: DOC_IDS.MORTGAGE_APPLICATION,
                enabled: true,
                fieldMappings: [
                    fm('borrower.firstName', F.FIRST_NAME, nameMatch()),
                    fm('borrower.lastName', F.LAST_NAME, nameMatch()),
                    fm('borrower.employer', F.EMPLOYER, nameMatch()),
                    fm('borrower.jobTitle', F.JOB_TITLE, nameMatch()),
                    fm('borrower.monthlyIncome', F.MONTHLY_INCOME, nameMatch()),
                ],
            },
            {
                docTypeId: DOC_IDS.MORTGAGE_APPROVAL,
                enabled: true,
                fieldMappings: [fm('borrower', F.FULL_NAME, nameMatch())],
            },
            {
                docTypeId: DOC_IDS.CLOSING_DISCLOSURE,
                enabled: true,
        ...
        conditionalRequirements: [
            {
                ...
                conditions: [
                    {
                        sourceDocTypeId: DOC_IDS.PURCHASE_AGREEMENT,
                        field: F.FINANCING_TYPE,
                        operator: 'exists',
                    },
                ],
            },
        ...
        dataSources: [
            {
                ...
                isRequired: true,
                canCreateEntity: true,
                fieldMappings: [fm(F.PROPERTY_ADDRESS, F.PROPERTY_ADDRESS, addressMatch())],
            },
            {
                docTypeId: DOC_IDS.DEED,
                enabled: true,
            ...
            {
                docTypeId: DOC_IDS.TITLE_REPORT,
                enabled: true,
                isRequired: true,
                fieldMappings: [
                    fm(F.PROPERTY_ADDRESS, F.PROPERTY_ADDRESS, addressMatch()),
            ...
            {
                docTypeId: DOC_IDS.INSPECTION_REPORT,
                enabled: true,
                fieldMappings: [
                    fm(F.PROPERTY_ADDRESS, F.PROPERTY_ADDRESS, addressMatch()),
        ...
        dataSources: [
            {
                ...
                canCreateEntity: true,
                fieldMappings: [
                    fm(F.PURCHASE_PRICE, F.PURCHASE_PRICE),
                    fm(F.CLOSING_DATE, F.CLOSING_DATE),
                    fm(F.EARNEST_MONEY, F.EARNEST_MONEY),
                    fm(F.FINANCING_TYPE, F.FINANCING_TYPE),
            ...
            },
            {
                ...
                isRequired: true,
                fieldMappings: [
                    fm(F.SALE_PRICE, F.SALE_PRICE),
                    fm(F.TOTAL_CLOSING_COSTS, F.TOTAL_CLOSING_COSTS),
                    fm(F.LOAN_AMOUNT, F.LOAN_AMOUNT),
                    fm(F.INTEREST_RATE, F.INTEREST_RATE),
                    fm(F.MONTHLY_PAYMENT, F.MONTHLY_PAYMENT),
                    fm(F.CASH_TO_CLOSE, F.CASH_TO_CLOSE),
                    fm(F.SELLER_PROCEEDS, F.SELLER_PROCEEDS),
                ],
            },
            {
                docTypeId: DOC_IDS.MORTGAGE_APPROVAL,
                enabled: true,
                fieldMappings: [
                    fm(F.APPROVED_AMOUNT, F.APPROVED_AMOUNT),
                    fm(F.INTEREST_RATE, F.INTEREST_RATE),
                    fm(F.LOAN_TYPE, F.LOAN_TYPE),
                    fm(F.LOAN_TERM, F.LOAN_TERM),
                ],
            },
        ],
        conditionalRequirements: [],
