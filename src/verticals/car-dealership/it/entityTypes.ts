...
export const entityTypes: EntityTypeDef[] = [
    {
        ...
        dataSources: [
            ...
            {
                docTypeId: DOC_IDS.ATTO_VENDITA,
                enabled: true,
                canCreateEntity: true,
                fieldMappings: [
                    fm('venditore.nome', F.NOME, cfMatch()),
                    fm('venditore.cognome', F.COGNOME, cfMatch()),
            ...
            },
            {
                ...
                enabled: true,
                fieldMappings: [fm(F.NOME, F.NOME, cfMatch()), fm(F.COGNOME, F.COGNOME, cfMatch())],
            },
            {
                docTypeId: DOC_IDS.PROCURA,
                enabled: true,
                fieldMappings: [
                    fm('nomeMandante', F.NOME, cfMatch()),
                    fm('cognomeMandante', F.COGNOME, cfMatch()),
        ...
        conditionalRequirements: [
            {
                docTypeId: DOC_IDS.VISURA_CAMERALE,
                enabled: true,
                conditions: [
                    {
                        sourceDocTypeId: DOC_IDS.ATTO_VENDITA,
                        field: 'venditore.codiceFiscale',
                        operator: 'lengthGreaterThan' as any,
                        value: '11',
                    },
                ],
            },
    ...
    },
    {
        ...
        dataSources: [
            ...
            },
            {
                ...
                canCreateEntity: true,
                fieldMappings: [
                    fm('acquirente.nome', F.NOME, cfMatch()),
                    fm('acquirente.cognome', F.COGNOME, cfMatch()),
            ...
            {
                docTypeId: DOC_IDS.FINANZIAMENTO,
                enabled: true,
                fieldMappings: [
        ...
        dataSources: [
            {
                ...
                fieldMappings: [
                    ...
                    fm(F.TELAIO, F.TELAIO, targaTelaioMatch()),
                    fm(F.MARCA, F.MARCA, targaTelaioMatch()),
                    fm(F.MODELLO, F.MODELLO, targaTelaioMatch()),
                    fm(F.ALLESTIMENTO, F.ALLESTIMENTO, targaTelaioMatch()),
                    fm(F.DATA_IMMATRICOLAZIONE, F.DATA_IMMATRICOLAZIONE, targaTelaioMatch()),
                    fm(F.CILINDRATA, F.CILINDRATA, targaTelaioMatch()),
                    fm(F.POTENZA_KW, F.POTENZA_KW, targaTelaioMatch()),
            ...
            {
                docTypeId: DOC_IDS.ASSICURAZIONE,
                enabled: true,
                fieldMappings: [fm(F.TARGA, F.TARGA, targaTelaioMatch())],
            },
            {
                docTypeId: DOC_IDS.REVISIONE,
                enabled: true,
                fieldMappings: [
                    fm(F.TARGA, F.TARGA, targaTelaioMatch()),
            ...
            {
                docTypeId: DOC_IDS.GARANZIA,
                enabled: true,
                fieldMappings: [fm(F.TARGA, F.TARGA, targaTelaioMatch())],
            },
            {
                docTypeId: DOC_IDS.SCHEDA_TECNICA,
                enabled: true,
                fieldMappings: [
                    fm(F.MARCA, F.MARCA, targaTelaioMatch()),
                    fm(F.MODELLO, F.MODELLO, targaTelaioMatch()),
        ...
        conditionalRequirements: [
            {
                ...
                conditions: [
                    {
                        sourceDocTypeId: DOC_IDS.LIBRETTO,
                        field: F.DATA_IMMATRICOLAZIONE,
                        operator: 'exists',
                        value: 'true',
                    },
                ],
        ...
        dataSources: [
            {
                ...
                canCreateEntity: true,
                fieldMappings: [
                    fm(F.PREZZO, F.PREZZO),
                    fm(F.DATA_VENDITA, F.DATA_VENDITA),
                    fm(F.KM, F.KM),
                    fm(F.MODALITA_PAGAMENTO, F.MODALITA_PAGAMENTO),
                ],
            },
            {
                docTypeId: DOC_IDS.FINANZIAMENTO,
                enabled: true,
                fieldMappings: [
                    fm(F.IMPORTO_FINANZIATO, F.IMPORTO_FINANZIATO),
                    fm(F.IMPORTO_RATA, F.IMPORTO_RATA),
                    fm(F.DURATA_RATE_MESI, F.DURATA_RATE_MESI),
                    fm(F.TAN, F.TAN),
                    fm(F.TAEG, F.TAEG),
                ],
            },
            {
                docTypeId: DOC_IDS.PERMUTA,
                enabled: true,
                fieldMappings: [fm(F.VALORE_PERMUTA, F.VALORE_PERMUTA)],
            },
        ],
        conditionalRequirements: [],
    },
