...
export const deed: DocumentTypeDef = {
    ...
    jsonSchema: objectSchema(
        {
            deedType: enumField('Type of deed', [
                'General Warranty',
                'Special Warranty',
                'Quitclaim',
                'Bargain and Sale',
            ...
            grantee: objectSchema(
                {
                    ...
                    vestingType: text(
                        'Vesting / How title is held (e.g. tenants in common, joint tenants)',
                    ),
            ...
            legalDescription: text(
                'Full legal description of the property (metes and bounds, lot/block, or plat reference)',
            ),
