...
export const documentazioneCondominiale: DocumentTypeDef = {
    ...
    description:
        "Dichiarazione dell'amministratore di condominio sulle spese e regolamento condominiale",
    references: [
        ref(
            'Art. 1117–1139 Codice Civile — Condominio',
            'https://www.normattiva.it/uri-res/N2Ls?urn:nir:stato:codice.civile:1942-03-16;262~art1117',
            ReferenceType.REGULATION,
        ),
        ref(
            'L. 220/2012 — Riforma del condominio',
            'https://www.normattiva.it/uri-res/N2Ls?urn:nir:stato:legge:2012-12-11;220',
            ReferenceType.REGULATION,
        ),
    ],
    jsonSchema: objectSchema(
        {
            ...
            unitaImmobiliare: text(
                "Identificazione dell'unità immobiliare (es. Scala A, Piano 3, Int. 5)",
            ),
            quoteRegolari: enumField('Le quote condominiali sono regolarmente pagate', [
                'sì',
                'no',
            ]),
            ...
            dataRilascio: date(
                'Data di rilascio della dichiarazione in formato europeo DD.MM.YYYY',
            ),
        },
        [
            'amministratore',
