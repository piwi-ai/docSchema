...
export const accettazioneEredita: DocumentTypeDef = {
    ...
    description:
        "Atto di accettazione dell'eredità trascritto in Conservatoria, necessario per la vendita di immobili ereditati",
    references: [
        ref(
            'Art. 459–511 Codice Civile — Successioni',
            'https://www.normattiva.it/uri-res/N2Ls?urn:nir:stato:codice.civile:1942-03-16;262~art459',
    ...
    jsonSchema: objectSchema(
        {
            ...
            tipoAccettazione: enumField('Tipo di accettazione', [
                'pura e semplice',
