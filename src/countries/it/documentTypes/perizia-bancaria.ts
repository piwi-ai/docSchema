...
import { text, num, date, objectSchema, ref } from '../helpers.js';
...
export const periziaBancaria: DocumentTypeDef = {
    ...
    description:
        "Perizia estimativa dell'immobile richiesta dalla banca per la concessione del mutuo",
    references: [
        ref(
            'ABI — Linee guida valuazione immobiliare',
            'https://www.abi.it/',
    ...
    jsonSchema: objectSchema(
        {
            ...
            statoConservazione: text(
                'Stato di conservazione (es. buono, ottimo, da ristrutturare)',
            ),
            ...
            note: text(
                'Note o osservazioni del perito — copiare TESTUALMENTE dal documento. Se non ci sono note, restituire stringa vuota.',
            ),
        },
