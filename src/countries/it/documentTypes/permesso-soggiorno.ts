...
export const permessoSoggiorno: DocumentTypeDef = {
    ...
    description:
        'Documento rilasciato dalla Questura per cittadini extracomunitari — richiesto per acquirenti/venditori non-UE',
    references: [
        ref(
    ...
    jsonSchema: objectSchema(
        {
            ...
            tipoPermesso: text(
                'Tipo di permesso (es. lavoro subordinato, famiglia, lungo soggiorno)',
            ),
