...
export const entityTypes: EntityTypeDef[] = [
    {
        ...
        dataSources: [
            ...
            {
                docTypeId: DOC_IDS.CU,
                enabled: true,
                canCreateEntity: true,
                fieldMappings: [
                    fm('percipiente.nome', F.NOME, cfMatch()),
                    fm('percipiente.cognome', F.COGNOME, cfMatch()),
                    fm('percipiente.codiceFiscale', F.CODICE_FISCALE, cfMatch()),
                    fm('percipiente.dataNascita', F.DATA_NASCITA, cfMatch()),
                ],
            },
            {
                docTypeId: DOC_IDS.MOD_730,
                enabled: true,
                fieldMappings: [
                    fm('contribuente.nome', F.NOME, cfMatch()),
                    fm('contribuente.cognome', F.COGNOME, cfMatch()),
                    fm('contribuente.codiceFiscale', F.CODICE_FISCALE, cfMatch()),
                ],
            },
            {
                docTypeId: DOC_IDS.REDDITI_PF,
                enabled: true,
                fieldMappings: [
                    fm('contribuente.nome', F.NOME, cfMatch()),
                    fm('contribuente.cognome', F.COGNOME, cfMatch()),
            ...
            {
                docTypeId: DOC_IDS.BUSTA_PAGA,
                enabled: true,
                fieldMappings: [
                    fm('dipendente.nome', F.NOME, cfMatch()),
                    fm('dipendente.cognome', F.COGNOME, cfMatch()),
                    fm('dipendente.codiceFiscale', F.CODICE_FISCALE, cfMatch()),
                ],
            },
            {
                docTypeId: DOC_IDS.CONTRATTO_LAVORO,
                enabled: true,
                fieldMappings: [
                    fm('dipendente.nome', F.NOME, cfMatch()),
                    fm('dipendente.cognome', F.COGNOME, cfMatch()),
            ...
            {
                docTypeId: DOC_IDS.ISEE,
                enabled: true,
                fieldMappings: [
                    fm('dichiarante.nome', F.NOME, cfMatch()),
                    fm('dichiarante.cognome', F.COGNOME, cfMatch()),
        ...
        conditionalRequirements: [
            {
                ...
                conditions: [
                    {
                        sourceDocTypeId: DOC_IDS.CU,
                        field: F.REDDITO_LORDO,
                        operator: 'exists',
                        value: 'true',
                    },
                ],
            },
            {
                ...
                conditions: [
                    {
                        sourceDocTypeId: DOC_IDS.FATTURA,
    ...
    },
    {
        ...
        dataSources: [
            ...
            {
                docTypeId: DOC_IDS.IVA_PERIODICA,
                enabled: true,
                fieldMappings: [
        ...
        conditionalRequirements: [
            {
                ...
                conditions: [
                    {
                        sourceDocTypeId: DOC_IDS.VISURA_CAMERALE,
                        field: F.FORMA_GIURIDICA,
                        operator: 'contains',
                        value: 'SR',
                    },
                ],
    ...
    },
    {
        ...
        dataSources: [
            ...
            },
            {
                ...
                enabled: true,
                canCreateEntity: true,
                fieldMappings: [fm(F.ANNO, F.ANNO, annoMatch())],
            },
            {
                docTypeId: DOC_IDS.BILANCIO,
                enabled: true,
