/**
 * Belgium specific field helpers.
 */
...
/** Numéro de registre national (National ID) */
export const personalId = (desc = 'Numéro de registre national') =>
    ({ type: 'string' as const, description: desc });

/** TVA / BTW (VAT Number) */
export const vat = (desc = 'TVA / BTW') =>
    ({ type: 'string' as const, description: desc });
