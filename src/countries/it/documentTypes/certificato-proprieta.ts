...
import { text, date, objectSchema, ref, codiceFiscale, targa, telaio } from '../helpers.js';
...
export const certificatoProprieta: DocumentTypeDef = {
    ...
    description:
        'Certificato di proprietà digitale (CDPD) — attesta la titolarità del veicolo al PRA',
    references: [
        ref(
            'ACI — Certificato di Proprietà Digitale',
            'https://www.aci.it/i-servizi/guide-utili/guida-pratiche-auto/certificato-di-proprieta.html',
