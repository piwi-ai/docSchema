...
export const mod730: DocumentTypeDef = {
    ...
    references: [
        ref(
            ...
            'https://www.agenziaentrate.gov.it/portale/web/guest/modello-730',
            ReferenceType.DOCUMENTATION,
        ),
        ref(
            'Istruzioni 730 (PDF)',
            'https://www.agenziaentrate.gov.it/portale/web/guest/modello-730/istruzioni-modello-730',
