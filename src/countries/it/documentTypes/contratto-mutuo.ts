...
import { text, num, date, enumField, objectSchema, ref, codiceFiscale } from '../helpers.js';
...
export const contrattoMutuo: DocumentTypeDef = {
    ...
    references: [
        ref(
            'Art. 1813–1822 Codice Civile — Mutuo',
            'https://www.normattiva.it/uri-res/N2Ls?urn:nir:stato:codice.civile:1942-03-16;262~art1813',
    ...
    jsonSchema: objectSchema(
        {
            ...
            codiceFiscaleMutuatario: codiceFiscale(
                'Codice Fiscale del mutuatario (extract without spaces)',
            ),
